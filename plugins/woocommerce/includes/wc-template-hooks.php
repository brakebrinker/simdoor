...
add_action( 'woocommerce_before_single_product_summary_descr', 'woocommerce_show_product_sale_flash', 10 );
...
add_action( 'woocommerce_single_product_summary_title', 'woocommerce_template_single_title', 10 );
remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_rating', 10 );
remove_action( 'woocommerce_after_single_product_summary_price', 'woocommerce_template_single_price', 10 );
 ...
 */
add_action( 'woocommerce_after_single_product_summary_price', 'woocommerce_template_single_add_to_cart', 30 );
