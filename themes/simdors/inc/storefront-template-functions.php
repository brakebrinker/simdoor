...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		?>
			<strong><?php echo esc_html( apply_filters( 'storefront_copyright_text', $content = '&copy; ' . date( 'Y' ) . ' ' . get_bloginfo( 'name' ) ) ); ?></strong>
			<?php if ( apply_filters( 'storefront_credit_link', true ) ) { ?>
			<?php // printf( esc_attr__( '%1$s designed by %2$s.', 'storefront' ), 'Storefront', '<a href="http://www.woocommerce.com" title="WooCommerce - The Best eCommerce Platform for WordPress" rel="author">WooCommerce</a>' ); ?>
			<?php } ?>
		<?php
	}
}

if ( ! function_exists( 'storefront_footer_phone' ) ) {
	/**
	 * Display the theme credit
	 *
	 * @since  1.0.0
...
if ( ! function_exists( 'storefront_footer_confidence' ) ) {
	/**
	 * Display the theme credit
	 *
	 * @since  1.0.0
...
if ( ! function_exists( 'storefront_footer_logo' ) ) {
	/**
	 * Display the theme credit
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_footer_logo() {
		?>
		<a href="#" class="dev"><img src="<?php echo esc_url( home_url( '/' ) ) . '/wp-content/themes/simdors/assets/img/logo2.png' ?>" alt=""></a>
		<?php
	}
}
...
if ( ! function_exists( 'storefront_call_number' ) ) {
	/**
	 * Site branding wrapper and display
	 *
	 * @since  1.0.0
...
if ( ! function_exists( 'storefront_order_call' ) ) {
	/**
	 * Site branding wrapper and display
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_order_call() {
		?>
		<!-- <div class="site-branding"> -->
...
if ( ! function_exists( 'storefront_menu_button' ) ) {
	/**
	 * Site branding wrapper and display
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_menu_button() {
		?>
...
if ( ! function_exists( 'storefront_site_title_or_logo' ) ) {
	...
	function storefront_site_title_or_logo( $echo = true ) {
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
			...
			$html = '<a href="' . esc_url( home_url( '/' ) ) . '" class="logo" rel="home"><img src="' . esc_url( home_url( '/' ) ) . '/wp-content/themes/simdors/assets/img/logo.png" alt=""></a>';
