...
add_action( 'storefront_header', 'storefront_call_number',                      10 );
add_action( 'storefront_header', 'storefront_order_call',                       20 );
...
//
add_action( 'storefront_header_post', 'storefront_primary_navigation',           0 );
add_action( 'storefront_header_post', 'storefront_menu_button',                 20 );
