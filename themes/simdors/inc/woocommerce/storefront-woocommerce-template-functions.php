	...
	function storefront_cart_link() {
		...
		<div class="col-md-2 col-sm-3 basket-link col-xs-5">
			<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'storefront' ); ?>">
				...
				<img src="<?php echo esc_url( home_url( '/' ) ) . '/wp-content/themes/simdors/assets/img/basket.svg' ?>" alt="">
				<span>В корзине<br/> <?php echo wp_kses_data( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'storefront' ), WC()->cart->get_cart_contents_count() ) );?></span>
			</a>
		</div>
		<?php
	}
